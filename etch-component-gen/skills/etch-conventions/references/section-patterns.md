...
HTML templates for all 7 section types. Every template follows the Etch structural hierarchy: `Section > Container > [content elements]`, uses BEM-only naming aligned with AutoBEM, and enforces accessibility defaults. All styling (padding, grid layout, button appearance, typography) is handled in CSS via ACSS custom properties -- see css-generation skill.
...
<section class="hero" aria-label="Page hero">
  <div class="hero__container">
    ...
    <div class="hero__actions">
      ...
      <a href="#" class="hero__cta-secondary">Learn More</a>
    </div>
  </div>
</section>
```
...
- Dual CTA pattern: primary + secondary (styling differentiated in CSS)
...
<section class="features-grid" aria-label="Features">
  <div class="features-grid__container">
    ...
    <ul class="features-grid__list" role="list">
...
**Notes:**
- All styling (padding, grid layout, button appearance, typography) is handled in CSS via ACSS custom properties -- see css-generation skill
  ...
  <div class="pricing__container">
    ...
    <div class="pricing__grid">
      ...
      <article class="pricing__card" aria-label="Starter plan">
        ...
        <a href="#" class="pricing__cta" aria-label="Get started with Starter plan">Get Started</a>
      </article>
      ...
      <article class="pricing__card pricing__card--popular" aria-label="Pro plan, most popular">
        ...
        <a href="#" class="pricing__cta" aria-label="Get started with Pro plan">Get Started</a>
      </article>
      ...
      <article class="pricing__card" aria-label="Enterprise plan">
        ...
        <a href="#" class="pricing__cta" aria-label="Contact sales for Enterprise plan">Contact Sales</a>
      </article>
...
<section class="cta-section" aria-label="Call to action">
  <div class="cta-section__container">
    ...
    <div class="cta-section__actions">
      <a href="#" class="cta-section__primary">Start Free Trial</a>
      <a href="#" class="cta-section__secondary">Schedule a Demo</a>
    </div>
  </div>
</section>
```
...
- Dual button pattern with primary and secondary actions (styled differently in CSS)
...
<header class="site-header" aria-label="Site header">
  <div class="site-header__container">
    ...
    <div class="site-header__actions">
      <a href="/login" class="site-header__login">Log In</a>
  ...
  <div class="site-header__mobile-nav" id="mobile-nav" aria-hidden="true" hidden>
    <nav aria-label="Mobile navigation">
      ...
      <div class="site-header__mobile-actions">
        <a href="/login" class="site-header__mobile-login">Log In</a>
        <a href="/signup" class="site-header__mobile-cta">Get Started</a>
      </div>
    </nav>
  </div>
