...
- **Alternatives**:
  ...
  - `[Action Verb] [Primary Keyword] in [Location] | [Company]`
- **Rules**:
...
- **Format**: `[What you offer/answer]. [Benefit or proof]. [CTA].`
- **Must include**:
...
## Open Graph Tags
- **og:title**: Same as title tag OR a shorter, punchier variant
- **og:description**: Same as meta description OR optimized for social sharing
- **og:type**: `website` (homepage) or `article` (blog/case study)
- **og:image**: Recommended 1200x630px for social sharing
...
- No trailing slash (pick one convention)
...
- Examples:
  ...
  - `/faq`
  - `/contact`
  - `/case-studies/client-name-project`
  - `/locations/dublin`
